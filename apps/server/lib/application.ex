defmodule Harvest.Server.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      # Start your own worker by calling: Harvest.Server.Worker.start_link(arg1, arg2, arg3)
      # worker(Harvest.Server.Worker, [arg1, arg2, arg3]),
    ]
